...
public:
    ...
    virtual void SetInstantaneousJointValues(const std::string& objectName, const std::vector<Real>& jointvalues, const std::string& unit="mm", const double timeout /* second */=5.0);
