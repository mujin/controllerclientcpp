...
/** \example mujindeletefile.cpp
    ...
    example1: mujindeleteitlprogram --controller_hostname=yourhost --itlprogramname=test
 */
...
bool ParseOptions(int argc, char ** argv, bpo::variables_map& opts)
{
    ...
    desc.add_options()
        ...
        ("itlprogramname", bpo::value<string>()->required(), "itl program name on controller to delete")
        ;
...
int main(int argc, char ** argv)
{
    ...
    const string itlprogramname = opts["itlprogramname"].as<string>();
    stringstream urlss;
    ...
    controllerclient->DeleteITLProgram(itlprogramname);
