...
public:
    ...
    virtual void GetScenePKs(std::vector<std::string> &pks);
    ...
    std::string CreateLink(const std::string& objectPk, const std::string& name, const Real quaternion[4], const Real translate[3], double timeout);
