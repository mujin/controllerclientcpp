// -*- coding: utf-8 -*-
/** \example mujinmovetoollinear.cpp

    Shows how to move tool to a specified position linearly.
    example1: mujinmovetoollinear --controller_hostname=yourhost --robotname=yourrobot --goals=700 600 500 0 0 180
    example2: mujinmovetoollinear --controller_hostname=yourhost --robotname=yourrobot --goals=700 600 500 0 0 180 --goaltype=translationdirection5d
 */
