...
#if MUJIN_CONTROLLERCLIENT_USEMSGPACK
...
void MsgPack::DumpMsgPack(const rapidjson::Value& value, std::ostream& os)
{
    msgpack::osbuffer buf(os);
    msgpack::pack(buf, value);
}

void MsgPack::DumpMsgPack(const rapidjson::Value& value, std::vector<char>& output)
{   
    msgpack::vbuffer buf(output);
    msgpack::pack(buf, value);
}

void MsgPack::ParseMsgPack(rapidjson::Document& d, const std::string& str)
{
...
void MsgPack::ParseMsgPack(rapidjson::Document& d, const void* data, size_t size)
{
    msgpack::unpacked unpacked;
...
void MsgPack::ParseMsgPack(rapidjson::Document& d, std::istream& is)
{
    std::string str;
    str.assign(std::istreambuf_iterator<char>(is), std::istreambuf_iterator<char>());
    MsgPack::ParseMsgPack(d, str);
}
...
void MsgPack::DumpMsgPack(const rapidjson::Value& value, std::ostream& os)
{
    throw mujinclient::MujinException(boost::str(boost::format("MsgPack support is not enabled")), mujinclient::MEC_Failed);
}
...
#endif  // MUJIN_CONTROLLERCLIENT_USEMSGPACK
